...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    WHERE constraint_name = 'messages_match_or_receiver_check' AND table_name = 'messages'
  ) THEN
    ALTER TABLE messages
...
DROP POLICY IF EXISTS "Users can view messages from their matches or instant chats" ON messages;
DROP POLICY IF EXISTS "Users can view messages from their matches or instant chats" ON messages;
DROP POLICY IF EXISTS "Users can view messages from their matches or instant chats" ON messages;
...
DROP POLICY IF EXISTS "Users can send messages to their matches or instant chats" ON messages;
DROP POLICY IF EXISTS "Users can send messages to their matches or instant chats" ON messages;
DROP POLICY IF EXISTS "Users can send messages to their matches or instant chats" ON messages;
