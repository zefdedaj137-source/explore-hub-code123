-- Run this in Supabase SQL Editor to create an atomic wallet purchase function.
-- This replaces client-side balance computation with a server-side transaction.
