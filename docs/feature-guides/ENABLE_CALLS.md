# 🚀 How to Enable Call System

## Step 1: Go to Supabase Studio
1. Open your browser
2. Go to: https://supabase.com/dashboard/project/fqmleivxlqqnlokconux
3. Click on **SQL Editor** in the left sidebar

## Step 2: Run This SQL

**IMPORTANT**: Copy ONLY the SQL code below (starting from `-- Drop old tables` and ending with the last `GRANT`). Do NOT copy the ```sql or ``` markers!
...
DROP TABLE IF EXISTS public.call_notifications CASCADE;
...
## Step 3: Make Your User Premium (for testing)

After running the above SQL, run this SQL to make yourself premium:
...
2. Go to a chat with a match
3. Click the phone icon (voice call) or video icon (video call)
4. The call dialog should open without errors!

## That's it! 🎉

The call system is now fully functional for premium users only.
